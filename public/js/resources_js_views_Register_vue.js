...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return _this.$store.dispatch('register', registerForm);

              case 4:
                _context.next = 6;
                return _this.$store.dispatch('login', registerForm);

              case 6:
                if (!(_this.getRegisterMessage === '')) {
                  _context.next = 9;
                  break;
                }
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(['getRegisterMessage']))
});
          ...
          [
            ...
            _c(
              ...
              [
                _c(
                  "router-link",
                  { staticClass: "quick-link", attrs: { to: "/login" } },
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "right-side w-40" }, [
      _c("div", { staticClass: "image-savings-4" })
    ])
  }
]
